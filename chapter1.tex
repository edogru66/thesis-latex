...
With the hundreds of thousands human genome have become accessible, researchers have become interested more about the question of what makes one individual different than the other. Early research results have suggested that 99.9\% of human genome is identical. Among 3 billion bases making up the human genome, it was only 3 million bases where all the differences in humans were attributed to. Figure \ref{geneticVariants} shows the frequency of presence 

\begin{figure}[ht]
\centering
\includegraphics[scale=0.5]{genomicVariation}
